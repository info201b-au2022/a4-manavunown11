...
These data points give more information that meets the eye. It is astonishing the number of black people in jails as recently as 2016, and their percentage in jails. As noted in the codebook, there were quiet a lot of missing variables, the presence of which would change the results significantly. Hence, it is safe to assume that the situation at present is much worse than originally assumed. Black people are significantly oppressed in the criminal justice system and seeing the 33.5% percentage alone can leave one astonished. 
